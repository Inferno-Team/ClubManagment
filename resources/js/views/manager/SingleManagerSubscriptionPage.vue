    ...
    <div>
        <div class="md-layout md-gutter px-5 py-2 mt-1">
            <div class="md-layout-item md-elevation-2 pt-3">
                <span class="md-title ">Attendency Graph</span>
...
export default {
    ...
    methods: {
        ...
        createSubscriptionChart() {
            ...
            this.subscriptionChart.data.labels = this.sub.attendencies_today.keys;
            this.subscriptionChart.data.datasets[0].data = this.sub.attendencies_today.values;

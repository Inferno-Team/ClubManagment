    ...
    <div>
        ...
        <div class="md-layout md-gutter px-5 py-2">
            <md-table class="md-layout-item md-elevation-2 pt-3"  v-if="club != null"
                v-model="paginatedCustomers" md-card md-sort="id" md-sort-order="asc">
                <md-table-toolbar>
                ...
                <md-table-row slot="md-table-row" slot-scope="{ item }">
                    ...
                    <md-table-cell md-label="subscription type" md-sort-by="sub.subscription.name">{{ item.sub.subscription.name }}</md-table-cell>
